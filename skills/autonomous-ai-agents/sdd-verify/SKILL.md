...
- This is the one independent requirements/runtime final verification. A contradiction or new failing check returns FAIL/escalation; it never starts 4R, review/refuter, another correction, or scoped validation.
