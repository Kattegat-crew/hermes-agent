---
name: "a11y-audit"
description: "Use when auditing WCAG 2.2 accessibility violations."
tags: [accessibility, wcag, a11y, contrast, aria, react, ci-cd, accesibilidad]
---
...
> See [references/framework-a11y-patterns.md] ⚠️ FALTA: references/framework-a11y-patterns.md for the complete fix patterns catalog.
...
> See [references/examples-by-framework.md] ⚠️ FALTA: references/examples-by-framework.md for Vue, Angular, Next.js, and Svelte examples.
...
|-----------|-------------|
| [wcag-quick-ref.md] ⚠️ FALTA: references/wcag-quick-ref.md | WCAG 2.2 Level A & AA criteria quick reference |
| [wcag-22-new-criteria.md] ⚠️ FALTA: references/wcag-22-new-criteria.md | New WCAG 2.2 success criteria (Focus Appearance, Target Size, etc.) |
| [aria-patterns.md] ⚠️ FALTA: references/aria-patterns.md | ARIA patterns, keyboard interaction, and live regions |
| [framework-a11y-patterns.md] ⚠️ FALTA: references/framework-a11y-patterns.md | Framework-specific fix patterns (React, Vue, Angular, Svelte, HTML) |
| [color-contrast-guide.md] ⚠️ FALTA: references/color-contrast-guide.md | Color contrast checker details, Tailwind palette mapping, sr-only class |
| [ci-cd-integration.md] ⚠️ FALTA: references/ci-cd-integration.md | GitHub Actions, GitLab CI, Azure DevOps, pre-commit hook configs |
| [audit-report-template.md] ⚠️ FALTA: references/audit-report-template.md | Stakeholder-ready audit report template |
| [testing-checklist.md] ⚠️ FALTA: references/testing-checklist.md | Manual testing checklist (keyboard, screen reader, visual, forms) |
| [examples-by-framework.md] ⚠️ FALTA: references/examples-by-framework.md | Full audit examples for Vue, Angular, Next.js, and Svelte |
