---
name: attribution
description: "Use when reconciling which channel really drove conversions"
tags: [attribution, atribucion, mmm, incrementality, utm, cac, posthog, first-party]
metadata:
  version: 1.1.0
---
...
For implementation, see the [tools registry] ⚠️ FALTA: ../../tools/REGISTRY.md. Key tools:

| Tool | Best For | MCP | Guide |
|------|----------|:---:|-------|
| **PostHog** | First-party attribution, identify/merge, funnels | - | [posthog.md] ⚠️ FALTA: ../../tools/integrations/posthog.md |
| **GA4** | Web analytics, model comparison, user-id stitching | ✓ | [ga4.md] ⚠️ FALTA: ../../tools/integrations/ga4.md |
| **Dub** | Short-link + click attribution | ✓ | [dub-co.md] ⚠️ FALTA: ../../tools/integrations/dub-co.md |
| **Segment** | CDP — route identify/track to every destination | - | [segment.md] ⚠️ FALTA: ../../tools/integrations/segment.md |
| **HubSpot** | CRM lead-source + self-reported fields | ✓ | [hubspot.md] ⚠️ FALTA: ../../tools/integrations/hubspot.md |
| **Salesforce** | CRM as revenue source of truth | - | [salesforce.md] ⚠️ FALTA: ../../tools/integrations/salesforce.md |
| **Supermetrics** | Pull platform numbers into one place to reconcile | ✓ | [supermetrics.md] ⚠️ FALTA: ../../tools/integrations/supermetrics.md |
| **RB2B** | De-anonymize B2B website visitors | - | [rb2b.md] ⚠️ FALTA: ../../tools/integrations/rb2b.md |
