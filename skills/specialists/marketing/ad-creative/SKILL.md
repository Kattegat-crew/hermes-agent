---
name: ad-creative
description: "Use when generating or iterating ad creative at scale."
tags: [ads, creatividades, copy-ads, meta-ads, google-ads, ugc, hooks]
metadata:
  version: 2.8.2
---
...
Per-concept format is defined in [references/static-ad-templates.md] ⚠️ FALTA: references/static-ad-templates.md. The human workflow this supports: open the folder, scan INDEX.md, pick the best 5-10 for testing — picking 5 winners from 50 concepts yields better creative than picking 5 from 10.

### Creative Review Page (client / stakeholder approval)

When a person who isn't you needs to review and pick — a client, a partner, a stakeholder — produce a **creative review page**: a self-contained HTML artifact that presents each concept as an in-feed platform mockup (Instagram/Facebook, with a whitelist-handle toggle), breaks carousels into a labeled frame-by-frame storyboard, lets them toggle headline/copy variations, and discloses what's grounded in real assets. It's the visual upgrade to INDEX.md — a decision made off one link instead of by reading markdown. The template ships at [assets/creative-review-template.html] ⚠️ FALTA: assets/creative-review-template.html (one file, no build, hostable anywhere); populate its `DATA` object from your generated concepts. Full data model, grounding rules (the disclosure block is required), and delivery in [references/creative-review-page.md] ⚠️ FALTA: references/creative-review-page.md.
...
For pulling performance data and managing campaigns, see the [tools registry] ⚠️ FALTA: ../../tools/REGISTRY.md.

| Platform | Pull Performance Data | Manage Campaigns | Guide |
|----------|:---------------------:|:----------------:|-------|
| **Google Ads** | `google-ads campaigns list`, `google-ads reports get` | `google-ads campaigns create` | [google-ads.md] ⚠️ FALTA: ../../tools/integrations/google-ads.md |
| **Meta Ads** | `meta-ads insights get` | `meta-ads campaigns list` | [meta-ads.md] ⚠️ FALTA: ../../tools/integrations/meta-ads.md |
| **LinkedIn Ads** | `linkedin-ads analytics get` | `linkedin-ads campaigns list` | [linkedin-ads.md] ⚠️ FALTA: ../../tools/integrations/linkedin-ads.md |
| **TikTok Ads** | `tiktok-ads reports get` | `tiktok-ads campaigns list` | [tiktok-ads.md] ⚠️ FALTA: ../../tools/integrations/tiktok-ads.md |
