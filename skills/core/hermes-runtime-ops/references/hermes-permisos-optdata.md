...
| Hook `post_tool_call` con `Permission denied` en rutas del repo | repo independiente del host `/root/<repo>` (visto desde el contenedor como `/host/root/<repo>`) o el árbol `data/repos/...` | Rutas root dentro del árbol de datos |
