---
name: agent-reach
description: "Use when researching or fetching from web/social platforms"
...
```bash
# Exa 网页搜索 (mcporter — sintaxis key=value, NO formato query:)
export $(grep -E "^EXA_API_KEY=" /opt/data/.env | xargs)  # requerido antes de mcporter
