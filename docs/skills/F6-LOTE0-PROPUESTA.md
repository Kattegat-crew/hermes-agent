...
| Fecha | 2026-09-23T15:00:00-0500 |
...
|---|---|---|---|---|---|---|
| `productivity/oauth-multi-tenant-integration` | `productivity/oauth-multi-tenant-integrations` | 0.5626 | False | 27 | 36 | bajo |
| `specialists/hermes-internal/brain-graph-operations` | `specialists/hermes-internal/brain-graph-ops` | 0.5909 | False | 68 | 40 | bajo |
| `specialists/marketing/analytics` | `specialists/marketing/analytics-tracking` | 0.4689 | False | 286 | 357 | bajo |
| `specialists/data-vector/pinecone` | `specialists/data-vector/pinecone-research` | 0.5045 | False | 339 | 66 | bajo |

## Propuesta por par

### `productivity/oauth-multi-tenant-integration`  ⇄  `productivity/oauth-multi-tenant-integrations`

- **Similitud oficial:** 0.5626
