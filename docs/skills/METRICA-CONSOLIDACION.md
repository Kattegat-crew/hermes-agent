...
| Fecha de medición | 2026-09-23 15:03:24-0500 |
...
| Catálogo medido | 719 `SKILL.md` |

## Resultado

| Métrica | Hoy | Referencia 22-sep-2026 |
|---|---|---|
| Pares sobre el umbral | **76** | 85 |
| Grupos (componentes conexas) | **38** | 45 |
| Skills implicadas | **94** | 115 |
| Porcentaje del catálogo | **13.07 %** | 16,0 % |
...
| 2 | `productivity/slackbot-automation` | `specialists/marketing/metaads-automation` | 0.8744 |
| 3 | `productivity/zoho-automation` | `specialists/marketing/metaads-automation` | 0.8744 |
...
| 6 | `software-development/hermes-desktop-ssh-backend` | `software-development/hermes-desktop-ssh-diagnostico` | 0.7261 |
| 7 | `specialists/ai-ml/pytorch-fsdp` | `specialists/ai-ml/unsloth` | 0.6846 |
| 8 | `software-development/onesignal_rest_api-automation` | `specialists/marketing/metaads-automation` | 0.6718 |
| 9 | `productivity/slackbot-automation` | `software-development/onesignal_rest_api-automation` | 0.6630 |
| 10 | `productivity/zoho-automation` | `software-development/onesignal_rest_api-automation` | 0.6630 |
| 11 | `specialists/marketing/ads` | `specialists/marketing/paid-ads` | 0.6462 |
| 12 | `productivity/colombia-juegos-promocionales` | `specialists/marketing-ads/colombia-promociones-legales` | 0.6353 |
| 13 | `software-development/amazon-sp-api` | `software-development/amazon-spapi-integration` | 0.6221 |
...
| 16 | `creative/bot-avatar-config` | `creative/neuralcrew-bot-avatars` | 0.5869 |
| 17 | `autonomous-ai-agents/sdd-explore` | `autonomous-ai-agents/sdd-propose` | 0.5855 |
| 18 | `autonomous-ai-agents/sdd-propose` | `autonomous-ai-agents/sdd-spec` | 0.5837 |
| 19 | `specialists/hermes-internal/hermes-desktop-windows-troubleshooting` | `specialists/hermes-internal/hermes-windows-install` | 0.5728 |
| 20 | `autonomous-ai-agents/sdd-design` | `autonomous-ai-agents/sdd-explore` | 0.5726 |
| 21 | `software-development/onesignal_rest_api-automation` | `specialists/marketing/microsoft-clarity-automation` | 0.5548 |
| 22 | `specialists/hermes-internal/client-agent-onboarding` | `specialists/hermes-internal/client-agent-soul-survey` | 0.5499 |
| 23 | `autonomous-ai-agents/sdd-design` | `autonomous-ai-agents/sdd-propose` | 0.5487 |
| 24 | `autonomous-ai-agents/sdd-explore` | `autonomous-ai-agents/sdd-init` | 0.5452 |
| 25 | `specialists/marketing/3-statement-model` | `specialists/marketing/lbo-model` | 0.5417 |

## Grupos detectados (38)
...
- **grupo_21** (2): `productivity/specification-handoff`, `software-development/service-agent-code-handoff`
- **grupo_22** (2): `software-development/amazon-sp-api`, `software-development/amazon-spapi-integration`
- **grupo_23** (2): `software-development/hermes-desktop-remote-backend`, `specialists/hermes-internal/hermes-desktop-remote-connection`
- **grupo_24** (2): `specialists/ai-ml/accelerate`, `specialists/ai-ml/pytorch-lightning`
- **grupo_25** (2): `specialists/ai-ml/serving-llms-vllm`, `specialists/ai-ml/tensorrt-llm`
- **grupo_26** (2): `specialists/comms/notification-delivery-reliability`, `specialists/marketing/cron-delivery-routing`
- **grupo_27** (2): `specialists/data-vector/pinecone`, `specialists/data-vector/pinecone-research`
- **grupo_28** (2): `specialists/hermes-internal/client-agent-onboarding`, `specialists/hermes-internal/client-agent-soul-survey`
- **grupo_29** (2): `specialists/hermes-internal/hermes-bible-study`, `specialists/marketing/hermes-bible`
- **grupo_30** (2): `specialists/hermes-internal/hermes-desktop-remote-gateway`, `specialists/hermes-internal/hermes-desktop-remote-setup`
- **grupo_31** (2): `specialists/hermes-internal/hermes-desktop-windows-troubleshooting`, `specialists/hermes-internal/hermes-windows-install`
- **grupo_32** (2): `specialists/hermes-internal/hermes-provider-fallback`, `specialists/hermes-internal/hermes-provider-resilience`
- **grupo_33** (2): `specialists/hermes-internal/skill-creator`, `specialists/hermes-internal/skill-improver`
- **grupo_34** (2): `specialists/marketing/3-statement-model`, `specialists/marketing/lbo-model`
- **grupo_35** (2): `specialists/marketing/ads`, `specialists/marketing/paid-ads`
- **grupo_36** (2): `specialists/marketing/copywriting`, `specialists/marketing/cro`
- **grupo_37** (2): `specialists/marketing/form-cro`, `specialists/marketing/signup`
- **grupo_38** (2): `specialists/marketing-ads/meta-ads-campaigns`, `specialists/marketing-ads/meta-ads-operations`
